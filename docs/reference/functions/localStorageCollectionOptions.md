...
Defined in: [packages/db/src/local-storage.ts:279](https://github.com/fcannizzaro/db/blob/main/packages/db/src/local-storage.ts#L279)
...
Defined in: [packages/db/src/local-storage.ts:299](https://github.com/fcannizzaro/db/blob/main/packages/db/src/local-storage.ts#L299)
